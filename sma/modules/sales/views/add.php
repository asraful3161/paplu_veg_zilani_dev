...
<?php if (TAX2) { ?>$('#ttax2').val(total_tax2.toFixed(2));<?php } ?>
                        ...
                        $("#name").autocomplete({
                            ...
                            $(this).removeClass('ui-autocomplete-loading');
                                ...
                                if(!checkExist){
                                var newTr = $('<tr id="row_' + count + '"></tr>');
                                newTr.html('<td><input class="nade-field" name="product' + count + '" type="hidden" value="' + item_code + '"><input class="span5 tran" name="item' + count + '" type="text" value="' + item_name.replace(/"/g, "&#034;").replace(/'/g, "&#039;") + ' (' + item_code + ')"></td><?php
if (PRODUCT_SERIAL) {
    echo '<td><input class="span2 tran2" name="serial\'+ count +\'" type="text" value=""></td>';
}
if (DISCOUNT_OPTION == 2) {
...
<?php if (TAX2) { ?>$('#ttax2').val(total_tax2.toFixed(2));<?php } ?>
                        ...
                        $("#codes").autocomplete({
                            ...
                            $(this).removeClass('ui-autocomplete-loading');
                                ...
                                if(!checkExist){
                                var newTr = $('<tr id="row_' + count + '"></tr>');
                                newTr.html('<td><input class="nade-field" name="product' + count + '" type="hidden" value="' + item_code + '"><input class="span5 tran" name="item' + count + '" type="text" value="' + item_name + ' (' + item_code + ')"></td><?php
if (PRODUCT_SERIAL) {
    echo '<td><input class="span2 tran2" name="serial\'+ count +\'" type="text" value=""></td>';
}
if (DISCOUNT_OPTION == 2) {
