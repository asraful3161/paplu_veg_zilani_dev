...
//                echo "</pre>";
                foreach ($inv_products as $prod) {
                    ...
                    . '<td>'
                    . '<input class="input-block-level text-center style="text-align:right;" id="tweight-' . $r . '" name="tweight-' . $r . '" type="text" ' . $readonly . ' value="' . $prod->sale_product_weight . '">'
                    . '<input class="mask input-block-level text-center style="text-align:right;" id="var_poductnote_' . $r . '"  name="var_poductnote' . $r . '"  type="text" value="' . $prod->variprod_note . '" ' . $readonly . ' />'
