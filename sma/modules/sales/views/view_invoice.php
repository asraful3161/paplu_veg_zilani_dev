...
//                . "</tr></table></div></td></tr>";
                        ...
                        <tbody>   
                            <?php  if ($rowsn === end($newMasterarr)){ 
                                    ...
                                    foreach ($rowsn as $rownlast) {
                                            if($rownlast->quantity==0.5){
                                                $newQuantity='1/2';
                                            }else{
                                                $newQuantity=$rownlast->quantity;
                                            }
                                ?>
     <tr style="height:18px; border:1px solid #eee; width:100%; "> 
                                    ...
                                    <td style="width: 210px; vertical-align:middle; padding-left: 15px; text-align:left; font-size: 15px; "><?php echo $rownlast->product_name; ?></td>
                                    <td style="width: 110px; text-align:center; vertical-align:middle; font-size: 14px;"><?php echo  $this->ion_auth->formatMoney($rownlast->weight); ?></td>
                                    <td style="width: 90px; text-align:center;  padding-right:5px; font-size: 14px; vertical-align:middle;"><?php echo $this->ion_auth->formatMoney($rownlast->unit_price); ?></td>
                                    <td style="width: 110px; text-align:center; vertical-align:middle; font-size: 14px;"><?php echo $this->ion_auth->formatMoney($rownlast->unit_price / $rownlast->weight); ?></td>
                                    <td style="width: 185px; text-align:center; vertical-align:middle;">
                                        <div style="text-align:center; font-size: 14px;"><?php //echo $rownlast->sale_product_weight1;?></div>
                                        <div style="text-align:center;">
                                            <?php
                                                if($rownlast->variprod_note!=''){ ?>
                                            <div class="breakdown" style="text-align:center; font-size: 12px;">
                                            <?php
                                                ...
                                                <?php }
                                                    ...
                                                    echo ' = '.$rownlast->sale_product_weight;
                                                }else{
                                                 ?>
                                            </div>
                                            <div class="fixed" style="text-align:center; font-size: 14px;">
                                                <?php   
                                    ...
                                    <td style="width: 90px; text-align:right; padding-right:10px; vertical-align:middle; font-size: 14px;"><?php echo $this->ion_auth->formatMoney($rownlast->gross_total); ?></td>
                                </tr>
                            ...
                            ?>
                                <tr style="height:18px; border:1px solid #eee; width:100%; "> 
                                    ...
                                    <td style="width: 210px; vertical-align:middle; padding-left: 15px; text-align:left; font-size: 15px; "><?php echo $rown->product_name; ?></td>
                                    <td style="width: 110px; text-align:center; vertical-align:middle; font-size: 14px;"><?php echo  $this->ion_auth->formatMoney($rown->weight); ?></td>
                                    <td style="width: 90px; text-align:center;  padding-right:5px; font-size: 14px; vertical-align:middle;"><?php echo $this->ion_auth->formatMoney($rown->unit_price); ?></td>
                                    <td style="width: 110px; text-align:center; vertical-align:middle; font-size: 14px;"><?php echo $this->ion_auth->formatMoney($rown->unit_price / $rown->weight); ?></td>
                                    <td style="width: 185px; text-align:center; vertical-align:middle;">
                                        <div style="text-align:center; font-size: 14px;"><?php //echo $rown->sale_product_weight1;?></div>
                                        <div style="text-align:center;">
                                            <?php
                                                if($rown->variprod_note!=''){ ?>
                                            <div class="breakdown" style="text-align:center; font-size: 12px;">
                                            <?php
                                    ...
                                    <td style="width: 90px; text-align:right; padding-right:10px; vertical-align:middle; font-size: 14px;"><?php echo $this->ion_auth->formatMoney($rown->gross_total); ?></td>
                                </tr>  
                               <?php  }  ?>
                ...
                <table width="40%" align="right"> 
                    ...
                    <td width="34%" valign="top">
                        ...
                        <table width="100%" class="table-bordered" style="background-color:#f5f5f5;" border="1">
                            ...
                            ?>
                            <?php echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . 'Previous Balance' . '</td><td style="text-align:right; padding-right:10px;">' . $this->ion_auth->formatMoney($cusPreBalance) . '</td></tr>'; ?>
                            <?php echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . 'Payment In After Invoice' . '</td><td style="text-align:right; padding-right:10px;">' . $this->ion_auth->formatMoney($latestPaymentmount) . '</td></tr>'; ?>
                            ...
                            <?php
                            $netTotal = $cusPreBalance + ($inv->total + $inv->total_tax2)- $latestPaymentmount;
                            ?>  

                            <?php
                            if (TAX2) {
                                echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . '<b>Total Amount Due</b>' . ' (<b>' . CURRENCY_PREFIX . '</b>)</td><td style="text-align:right; padding-right:10px;"><b>' . $this->ion_auth->formatMoney($netTotal) . '</b></td></tr>';
                            }
                            ?>
