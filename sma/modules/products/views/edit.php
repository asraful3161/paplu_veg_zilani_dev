...
<div class="control-group">
    ...
    <div class="controls">  <?php
        ...
        echo form_dropdown('category', $cat, $product->category_id, 'class="tip chzn-select span4" id="category" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("category") . '" title="' . $this->lang->line("pr_category_tip") . '" required="required" data-error="' . $this->lang->line("category") . ' ' . $this->lang->line("is_required") . '"');
        ?> </div>
</div>
<div class="control-group">
    ...
    <div class="controls" id="subcat_data"> <?php
        ...
        echo form_dropdown('subcategory', $sct, $product->subcategory_id, 'class="span4" id="subcategory"  data-placeholder="' . $this->lang->line("select_category_to_load") . '"');
        ?> </div>
</div>
<div class="control-group">
...
<div class="control-group">
    ...
    <div class="controls">  <?php
        ...
        echo form_dropdown('tax_rate', $tr, (isset($_POST['tax_rate']) ? $_POST['tax_rate'] : $product->tax_rate), 'id="tax_rate" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("product_tax") . '" required="required" data-error="' . $this->lang->line("product_tax") . ' ' . $this->lang->line("is_required") . '"');
?> </div>
</div>
<div class="control-group">
...
<div class="control-group">
    <label class="control-label" for="cf1">Product Type</label>
    <?php
    $ptype = $product->cf1;
    $nptype = "";
    if ($ptype == "") {
    ...
    ?>
    <div class="controls"> 
        <select class="span4" name="cf1" id="cf1">
            <option value="Fixed" <?php echo $nptype == "Fixed" ? "selected" : ""; ?>>Fixed Weight</option>
            <option value="Variable" <?php echo $nptype == "Variable" ? "selected" : ""; ?>>Variable Weight</option>
        </select>
<?php //echo form_input('cf1', $product->cf1, 'class="span4" id="cf1"'); ?>
    </div>
</div> 
<div class="control-group">
