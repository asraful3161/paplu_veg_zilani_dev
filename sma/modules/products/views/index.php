...
<h3 class="title"><?php echo $page_title; ?></h3>
  ...
  <a class="btn btn-primary pull-left" onclick="return confirm('Are you sure to reset?')" href="<?php echo base_url(); ?>index.php?module=products&amp;view=reset_stock">
               <?php echo 'Reset Stock'; ?>
           </a>
