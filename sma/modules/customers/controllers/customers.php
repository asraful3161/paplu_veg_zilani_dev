...
*/
   ...
   function getdatatableajax()
   {
	   ...
	   $this->datatables
			->select("id, name, company, mobile, email, city, country")
			->from("customers")
			->add_column("Actions", 
	...
	function add(){
		...
		$this->form_validation->set_rules('phone', $this->lang->line("phone"), 'xss_clean|min_length[9]|max_length[16]');
                $this->form_validation->set_rules('mobile', 'Mobile', 'required|xss_clean|min_length[9]|max_length[16]');
