...
class Settings_model extends CI_Model
{
	...
	function downTransHistory()
    {
        ...
        $query = $this->db->query("SELECT customers.name AS Customer_name, transaction_history . *
									FROM customers
									LEFT JOIN transaction_history ON customers.id = transaction_history.customer_id
									ORDER BY transaction_history.transaction_history_id DESC ");  
        $delimiter = ",";
        $newline = "\r\n";
        $data = $this->dbutil->csv_from_result($query, $delimiter, $newline);
        force_download("business_transaction_history_$date.csv", $data);
    }
