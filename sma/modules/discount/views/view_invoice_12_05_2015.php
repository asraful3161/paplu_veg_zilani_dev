                ...
                <table width="40%" align="right"> 
                    ...
                    <td width="34%" valign="top">
                        ...
                        <table width="100%" class="table-bordered" style="background-color:#f5f5f5;" border="1">
                            ...
                            <?php echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . 'Payment after Purchase' . '</td><td style="text-align:right; padding-right:10px;">' . $this->ion_auth->formatMoney($latestPaymentmount) . '</td></tr>'; ?>
