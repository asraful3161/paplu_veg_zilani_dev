...
<div style="clear: both;"></div>	
	...
	<?php echo '<th style="padding-right:20px; text-align:center; vertical-align:middle;">Total Weight</th>'; ?>
	...
	<?php
        ...
        $r = 1; foreach ($rows as $row):?>
			...
			<tr>
                ...
                <td style="vertical-align:middle; text-align:center;"><?php echo $row->product_name." (".$row->product_code.")"; ?>
                ...
                <td style="width: 130px; text-align:center; vertical-align:middle;"><?php echo $row->weight; ?></td>
                ...
                <th style="width: 130px; text-align:center; vertical-align:middle;"><?php echo $row->unit_price / $row->weight; ?></th>
                <?php //if(DISCOUNT_OPTION == 2) { echo '<td style="width: 80px; text-align:center; vertical-align:middle;">'.$row->discount_val.'</td>'; } ?>
                <?php if(TAX1) { echo '<td style="width: 80px; text-align:center; vertical-align:middle;"><!--<small>('.$row->tax.')</small>--> '.$this->ion_auth->formatMoney($row->val_tax).'</td>'; } ?>
                <?php echo '<td style="width: 80px; text-align:center; vertical-align:middle;">'.($row->weight * $row->quantity).'</td>';?>
...
<tr><td colspan="<?php echo $col; ?>" style="text-align:right; padding-right:10px; font-weight:bold;"><?php echo 'Total Amount Due'; ?> (<?php echo CURRENCY_PREFIX; ?>)</td><td style="text-align:right; padding-right:10px; font-weight:bold;"><?php echo $this->ion_auth->formatMoney($inv->total+$inv->shipping); ?></td></tr>
