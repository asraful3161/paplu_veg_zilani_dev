...
<div id="printableArea">          
    ...
    <div style="clear:both;"></div>
        ...
        <table>
            <tr>
                 <td style="font-size:14px;text-align:right;">Customer Name :</td> 
                 <td style="text-align:left; width:100px;"><?php echo $customer->name; ?></td>
            </tr>
            <tr>
                 <td style="font-size:14px; text-align:right;">City :</td> 
                 <td style="text-align:left; width:100px;"><?php echo $customer->city; ?></td> 
            </tr>
            <tr>
                 <td style="font-size:14px; text-align:right;">State :</td> 
                 <td style="text-align:left; width:100px;"><?php echo $customer->state; ?></td> 
            </tr>
            <tr>
                 <td style="font-size:14px; text-align:right;">Phone :</td> 
                 <td style="text-align:left; width:100px;"><?php echo $customer->phone; ?></td> 
            </tr>
            <tr>
                 <td style="font-size:14px; text-align:right;">Email :</td> 
                 <td style="text-align:left; width:100px;"><?php echo $customer->email; ?></td> 
            </tr>
	...
	<?php $r = 1; foreach ($rows as $row):?>
		<tr>
                ...
                <td><?php echo "<img src='".base_url()."index.php?module=products&view=gen_barcode&code=".$row->product_code."&height=25&width=150' alt='".$row->product_code."' />";
                ?></td>
                <td><?php echo $row->weight; ?></td>
                <td><?php echo $this->ion_auth->formatMoney($row->unit_price); ?></td>
                <td><?php echo $this->ion_auth->formatMoney($row->gross_total); ?></td> 
		</tr> 
    <?php 
		$r++; 
		endforeach;
