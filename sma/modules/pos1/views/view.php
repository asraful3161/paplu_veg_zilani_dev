                                ...
                                if ($rowsn === end($newMasterarr)) {
                                    ...
                                    foreach ($rowsn as $rownlast) {
                                        ...
                                        <tr style="border:1px solid #eee; width:100%; "> 
                                            <td style="text-align:center; vertical-align:middle; font-size: 15px;"><?php echo $newQuantity; ?></td>
        ...
        foreach ($rowsn as $rown) {
            ...
            ?>
                                        <tr style="height:18px; border:1px solid #eee; ">  
                                            <td style="text-align:center; width:40px; vertical-align:middle; font-size: 15px;"><?php echo $newQuantity; ?></td> 
