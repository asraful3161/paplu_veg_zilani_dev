...
<?php if ($this->ion_auth->in_group(array('owner', 'admin'))) { ?>
                        <ul class="menu nav nav-tabs nav-stacked">
                            ...
                            <li class="dropdown"><a class="showSubMenus" href="#discountMenu"><i class="icon-tags icon-white"></i>Customer<b class="caret"></b></a>
                                <ul class="nav nav-tabs nav-stacked sub-menu" id="discountMenu"> 
                                    <li><a href="<?php echo base_url(); ?>index.php?module=customers"><?php echo $this->lang->line('list_customers'); ?></a></li>
                                    <li><a href="<?php echo base_url(); ?>index.php?module=customers&amp;view=add"><?php echo 'Add Customer'; ?></a></li>
                                    <li><a href="<?php echo base_url(); ?>index.php?module=customers&amp;view=add_by_csv"><?php echo $this->lang->line('add_customers_by_csv'); ?></a></li>
                                    <li><a href="<?php echo base_url(); ?>index.php?module=discount&amp;view=customer_discounts">Add Discount</a></li>  
                                    <li><a href="<?php echo base_url(); ?>index.php?module=discount&amp;view=list_customer_balance"><?php echo "Update Balance"; ?></a></li>
                                    <li><a href="<?php echo base_url(); ?>index.php?module=discount&amp;view=customer_transaction_history"><?php echo "Transaction History"; ?></a></li>  
                                </ul>
                             </li>
                             <li class="dropdown"><a class="showSubMenus" href="#purchasesMenu"><i class="icon-star icon-white"></i> <?php echo 'Stock In'; ?> <b class="caret"></b></a>
                                <ul class="nav nav-tabs nav-stacked sub-menu" id="purchasesMenu">
                                    <li><a href="<?php echo base_url(); ?>index.php?module=inventories"><?php echo 'List Stock'; ?></a></li>
                                    <li><a href="<?php echo base_url(); ?>index.php?module=inventories&amp;view=add"><?php echo 'Add Stock'; ?></a></li>
                            ...
                            <li class="dropdown"><a class="showSubMenus" href="#salesMenu"><i class="icon-heart  icon-white"></i> <?php echo $this->lang->line('sales'); ?> <b class="caret"></b></a>
                                <ul class="nav nav-tabs nav-stacked sub-menu" id="salesMenu">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>index.php?module=sales&amp;view=add"><?php echo $this->lang->line('add_sale'); ?></a></li>
    ...
    <?php if ($this->ion_auth->in_group('owner')) { ?>
                                ...
                                <li class="dropdown"><a class="showSubMenus" href="#backupMenu"><i class="icon-download icon-white"></i>Backup<b class="caret"></b></a>
                                    <ul class="nav nav-tabs nav-stacked sub-menu" id="backupMenu"> 
                                        <li><a href="<?php echo base_url(); ?>index.php?module=settings&amp;view=backup_database"><?php echo $this->lang->line('backup_database'); ?></a></li>
                                        <li><a href="<?php echo base_url(); ?>index.php?module=settings&amp;view=down_trans_history"><?php echo "Excel Download"; ?></a></li>
                                    </ul>
                                </li>
