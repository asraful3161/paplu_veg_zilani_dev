...
<?php if (PRODUCT_SERIAL) { ?>
            $('#serial-' + rw_no).val($('#item_serial_no').val()); <?php } ?>
<?php if (TAX1) { ?>
            $('#tax_rate-' + rw_no).val($('#item_tax').val()); <?php } ?>
<?php if (DISCOUNT_OPTION == 2) { ?>
