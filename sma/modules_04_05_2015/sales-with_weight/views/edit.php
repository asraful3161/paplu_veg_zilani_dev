...
<div class="control-group table-group">
    ...
    <div class="controls table-controls">
        <table id="dyTable" class="table items table-striped table-bordered table-condensed table-hover">
            ...
            <th class="span2"><?php echo 'Total Weight' ?></th>
...
//echo "</pre>";
                foreach ($inv_products as $prod) {
                    ...
                    echo '<td><input class="input-block-level text-center" name="quantity' . $r . '" id="quantity-' . $r . '" type="text" value="' . $prod->quantity . '"></td>'
                    . '<td><input class="span2 tran" style="text-align:right;" name="unit_price' . $r . '" name="price-' . $r . '" type="text" value="' . $prod->unit_price . '"></td>'
                    . '<td><input class="input-block-level text-center style="text-align:right;" name="total_weight' . $r . '" name="tweight-' . $r . '" type="text" value="' . $prod->product_weight * $prod->quantity . '"></td>'
