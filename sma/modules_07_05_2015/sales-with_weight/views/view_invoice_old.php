...
<table cellspacing="25" cellpadding="15" class="table table-responsive">
    <tr>
        <td>
    ...
    <td>
        ...
        <?php echo "Current Balance (USD):"." ".$cusBalance->customer_balance; ?></p>   
...
<div style="clear: both;"></div>	
    ...
    <?php 
		...
		endforeach;
	?>
    <?php $col = 5;  if(PRODUCT_SERIAL) { $col += 1; } if(DISCOUNT_OPTION == 2) { $col += 1; } if(TAX1) { $col += 1; } ?>
