   ...
   function ajaxproducts( $category_id = NULL) {
	...
	$this->load->library("pagination");
		...
		if($product->image == 'no_image.jpg') {
			$prods .= "
			<button id=\"product-".$category_id.$count."\" type=\"button\" value='".$product->code."' class=\"green\" ><i><img src=\"assets/uploads/thumbs/default.png\"></i><span><span>".$product->name."</span></span><span>Qty: ".$product->available_quantity."</span></button>";
		} else {
			$prods .= "
